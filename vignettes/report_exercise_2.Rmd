...
# Figure 1 - (Geom_line)
disclaimer: Solar Radiation has missing values. Due to that the quality of the data and therefore of the figure is  limited
```{r message=FALSE}
ggplot2::ggplot(
  airquality_2,
...
#### Figure 2
disclaimer: Solar Radiation has missing values, due to that 7 rows got removed. I decided to set the warning to FALSE for a more pleasant presentation in the html.
