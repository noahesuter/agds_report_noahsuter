...
pairs.panels(half_hourly_fluxes_op1[,c("PPFD_IN", "siteid", "LW_IN_F", "VPD_F_MDS", "TA_F_MDS","SW_IN_F", "WS_F", "USTAR",  "VPD_F", "CO2_F_MDS", "PA_F", "TIMESTAMP", "P_F")], method= "spearman", lm=TRUE)
```
...
```{r error=TRUE}
stats::extractAIC(model_op2) #AIC model option 2 - how do i get that?
```
